...
1. <input type="checkbox" checked="checked" disabled /> A Random Walk Down Wall Street – Burton G. Malkiel
1. <input type="checkbox" checked="checked" disabled /> Antifragile – Nassim Taleb (re-read from 2016's list)
...
1. <input type="checkbox" /> Barbarians at the Gate – Bryan Burrough & John Helyar
1. <input type="checkbox" /> How Money Got Free – Brian Patrick Eha
