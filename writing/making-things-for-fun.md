...
This is not a blog—it's a fun side-project done over a couple weekends. It's not a blog because it's not using any blogging software, per se, just some elbow grease and [a few bash scripts][1] that I've managed to string together into a mostly-working state.

Simple products are fashionable, especially when it comes to media consumption, and even I've been known to write a Medium post every now and again, but I didn't set out to build this as a monument to simplicity. This isn't that type of place and I'm not that type of fella.
...
I made this because it was fun. It was more fun figuring out how to [easily inline all the assets][2] and [strip out unused css][3] on this page than it would have been to set up Wordpress again. But the first time I set up Wordpress was a magical and transcendent experience the first time I did it in 2008, so why am I seemingly so quick to shun it now?
...
<footer>
  <ol>
    <li id="making-things-for-fun_footnote-01">
      The custom cursors (provided they're still here, if not, I'll include a gif) were a fun idea I gleaned from [@kwuchu][6] tweeting about redesigning his portfolio site, which featured a similarly cropped picture of him. I already had the avatar and had been using it for a few years, but when I threw it on the static, it was static and unmoving and no fun whatsoever. I don't know how I looked into the custom CSS cursor, but I definitely used [David Walsh's blog post][7] to see it in action and grok how it should work. Then [@ohhoe][8] asked my to make sparkle trails and I couldn't say "no" to that.
    </li>
